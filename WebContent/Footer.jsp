            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-top-box">
                            <h3>Business Time</h3>
                            <ul class="list-time">
                                <li>Monday - Sunday: 08.00am to 07.00pm</li> <li>Closed: Public Holidays</li> 
                            </ul>
                        </div>
                    </div>
				...
				<div class="col-lg-4 col-md-12 col-sm-12">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <h4>About MeetShop</h4>
                            <p>MeatShop this is the project that provides you fresh meat at your doorstep. The meat will be ceritified .</p> 
							</div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link">
                            ...
                            <ul>
                                ...
                                <li><a href="ContactUs.jsp">Customer Service</a></li>
                                </ul>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-12 col-sm-12">
